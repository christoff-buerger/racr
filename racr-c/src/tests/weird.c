...
/*
	...
	printf("racr_ast_for_each_child\n");
	Scheme_Object* f = scheme_make_prim_w_arity(child_func, "child_func", 2, 2);
	racr_ast_for_each_child(f, ast, racr_build_bounds(3, bounds));
*/
